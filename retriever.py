...
SYNONYMS = {
    ...
    "reimburse": ["expense", "expenses", "concur"],
    "reimbursed": ["expense", "expenses", "concur"],
    "reimbursing": ["expense", "expenses", "concur"],
    "reimburses": ["expense", "expenses", "concur"],
    "pay": ["expense", "reimbursement", "concur"],
    "paid": ["expense", "reimbursement", "concur"],
    "expense": ["reimbursement", "concur"],
    "expenses": ["reimbursement", "concur"],
